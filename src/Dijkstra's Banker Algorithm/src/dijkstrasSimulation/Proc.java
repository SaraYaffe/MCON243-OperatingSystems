...
public class Proc {
	...
	public int resourceRequest(int available) {
		if (running) {
			...
			// the maximum resources it can need even though in reality a process can
			// complete without the full amount. 
			//If all resources are held, complete with some probability.
