...
public class SlaveB {
    public static void main(String[] args) throws InterruptedException {
        ...
        SlaveType slaveType = SlaveType.B;

        //create threads to communicate with master
        Thread slave_fromMaster = new SlaveB_fromMaster(pendingJobs, pendingJobs_LOCK);
        Thread slave_toMaster = new SlaveB_toMaster(completedJobs, completedJobs_LOCK);
